...
def _init_dssp_data():
    ...
    PROTEIN_DSSP_DATA = parse_dssp_file(
        pkg_resources.resource_filename(__package__, "full_protein_dssp"))
    PROTEIN_DSSP_DATA.update(
        parse_dssp_file(pkg_resources.resource_filename(__package__, "single_domain_dssp")))
    with open(pkg_resources.resource_filename(__package__, "astral_data"), "r") as astral_file:
